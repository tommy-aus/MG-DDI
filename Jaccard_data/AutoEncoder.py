...
class AE(nn.Module):
    def __init__(self, n_enc_1, n_enc_2, n_input, n_z):
        ...
        self.z_layer = Linear(n_enc_2, n_z)    #1024->500

        self.dec_1 = Linear(n_z,n_enc_2)  #500->1024
...
def pretrain_ae(model, dataset):
    ...
    for epoch in range(100):
        ...
        if epoch == 99:
            ...
            print (X_Z.shape)
            np.savetxt('z_class500.csv',X_Z,delimiter=',')

        torch.save(model.state_dict(), 'pre_ae_881_2048_1024_500.pkl')
